...
const AAModal = ({ visible, onClose, onSave, title = "AA" }:any) => {
  ...
  // Generate quadruple digit numbers based on input digits
  const generateQuadrupleNumbers = (digits:any, amountValue:any) => {
    ...
    const numbers = uniqueDigits.map((digit:any) => {
      const quadrupleNumber = digit + digit + digit + digit; // e.g., '0' becomes '0000'
      return {
        number: quadrupleNumber,
  ...
  useEffect(() => {
    const numbers = generateQuadrupleNumbers(akharBahar, amount);
  ...
  const handleSave = () => {
    ...
    const transactions = generatedNumbers.map((item:any) => ({
  ...
  const handleAkharBaharChange = (text:any) => {
    // Only allow digits 0-9, remove duplicates and non-digits
    const validDigits = text.split('').filter((char:any) => 
      char >= '0' && char <= '9'
    );
          ...
          <ScrollView showsVerticalScrollIndicator={false}>
            ...
            <View style={styles.noteSection}>
              ...
              <Text style={styles.noteText}>
                Akhar number should be 1 digit without any separator. Each digit will create a 4-digit number.
              </Text>
            </View>
            ...
            <View style={styles.instructionSection}>
              ...
              <Text style={styles.instructionText}>
                • Each digit will create a 4-digit number (e.g., 1 → 1111)
              </Text>
              <Text style={styles.instructionText}>
                • Example: Input "025" creates 0000, 2222, 5555 with your amount
              </Text>
              <Text style={styles.instructionText}>
                • Duplicate digits are automatically removed
              </Text>
              <Text style={styles.instructionText}>
                • Perfect for creating all same-digit 4-digit combinations
              </Text>
            </View>
          </ScrollView>
