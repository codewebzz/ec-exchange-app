        ...
        >
          <ReportTable
            ...
            columns={[
              ...
              { key: 'tpc', label: 'TPC', width: 100, align: 'right', numeric: true },
              { key: 'tpHissaAmt', label: 'TPC-H-AMT', width: 120, align: 'right', numeric: true },
              { key: 'tphissa', label: 'TP-Hissa', width: 100, align: 'right', numeric: true },
              { key: 'tpc_percentage', label: 'TPC%', width: 100, align: 'right', numeric: true },
              { 
                key: 'total', 
                label: 'Total', 
                width: 120, 
